...
namespace SalesProjectMVC.Data
{
    ...
    {
        private SalesProjectMVCContext _salesContext;

        public SeedingService(SalesProjectMVCContext salesContext)
        {
        ...
        public void Seed()
        {
            if (_salesContext.Department.Any() ||
                _salesContext.Seller.Any() ||
                _salesContext.SalesRecord.Any())
                return;
            ...
            _salesContext.Department.AddRange(d1, d2, d3, d4);
            _salesContext.Seller.AddRange(s1, s2, s3, s4, s5, s6);
            _salesContext.SalesRecord.AddRange(r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13, r14,
